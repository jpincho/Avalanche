...
struct STriangle
{
	void SetColor(int i, unsigned char r, unsigned char g, unsigned char b) {m_Red[i] = r; m_Green[i] = g; m_Blue[i] = b;}
	void SetPosition(int i, float x, float y) {m_Px[i] = x; m_Py[i] = y;}
